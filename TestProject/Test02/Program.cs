...
namespace Test02 {
    class Program {
        ...
        private static void Exercise02(List<int> numbers) {
            var maxNumber = numbers.Where(i => i % 2 == 0).Max();
        ...
        private static void Exercise03(List<int> numbers) {
            var OrderByNumber = numbers.OrderBy(i=> i);
            foreach(var i in OrderByNumber) {
                Console.Write("{0} ",i);
            }
        }
        ...
        private static void Exercise04(List<int> numbers) {
            var number = numbers.Where(i => i>=10).Where(i=> i<=50);
